output: ipd.o
	gcc my_socket.o arp_linked_list.o ip_linked_list.o misc.o arp_protocol.o ipd.o -pthread -o ipd

ipd.o: global_defines.h ipd.h my_socket.o arp_linked_list.o ip_linked_list.o misc.o arp_protocol.o ipd.c
